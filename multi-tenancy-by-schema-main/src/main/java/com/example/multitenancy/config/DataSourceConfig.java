...
public class DataSourceConfig {
    ...
    public DataSource dataSource() {
        ...
        DataSource user1DataSource = createDataSource("jdbc:postgresql://localhost:5432/keycloak", "postgres", "Root", "user1");
        DataSource user2DataSource = createDataSource("jdbc:postgresql://localhost:5432/keycloak", "postgres", "Root", "user2");
        DataSource defaultDS = createDataSource("jdbc:postgresql://localhost:5432/keycloak", "postgres", "Root");
